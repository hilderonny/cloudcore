...
describe('API setpubliclywritable', function() {
    ...
    xit('All users can write when set to true', async function() {
    });

    xit('Only specific users can write when set to false', async function() {
    });

    xit('When already set to false, setting to false again has no effect', async function() {
    });

    xit('When already set to true, setting to true again has no effect', async function() {
    });
