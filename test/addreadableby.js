...
describe('API addreadableby', function() {
    ...
    xit('Target user can read on success, but not write automatically', async function() {
    });

    xit('When target user is already in readable, no double entry is made in array', async function() {
    });
