...
describe('API removewritableby', function() {
    ...
    xit('Target user can not write anymore on success, but potentially can read', async function() {
    });

    xit('When target user is not in writable before, nothing happens', async function() {
    });
